    	    ...
    	    <div class="col-md-4 col-md-offset-4">
    	        <div class="panel panel-default">
    	            ...
    	            <div class="panel-body">
    	                <form class="form-horizontal" role="form" action="update1.php" method="post">
    	                
						<div class="form-group">
    	                    <label for="inputName" class="col-sm-3 control-label">
    	                        Name</label>
    	                    <div class="col-sm-9">
    	                        <input type="text" class="form-control" id="inputName" 	placeholder="Pharmaceutical Company's Name" required="True" name="name">
    	                    </div>
    	                </div>
						...
						<div class="form-group">
    	                    <label for="inputFormula" class="col-sm-3 control-label">
								Phone</label>
    	                    <div class="col-sm-9">
    	                        <input type="text" class="form-control" id="inputPhoneNumber" 	placeholder="Phone Number" name="phone" required="True">
    	                    </div>
    	                </div>
						
						<div class="form-group">
    	                    <label for="inputPharmaceuticalCompanyd" class="col-sm-3 control-label">
							</label>
    	                    <div class="col-sm-9">
    	                        <input type="hidden"  id="inputPharmaceuticalCompanyid"  name="cid" value="<? echo intval($_GET['id']) ?>">
    	                    </div>
    	                </div>
    	                ...
    	                <div class="form-group last">
    	                    <div class="col-sm-offset-3 col-sm-6 pull-left">
    	                        <button type="submit" class="btn btn-warning btn-sm pull-left">
									Update</button>
								 <button class="btn btn-info btn-sm pull-right"><a href="view_PharmaceuticalCompany.php">Manage</a></button>
    	                    </div>
    	                </div>
    	                </form>
    	            </div>
...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		$fm = mysqli_real_escape_string($conn, trim($_POST['phone']));
		$ci = mysqli_real_escape_string($conn, trim($_POST['cid']));
		if ($fm>9999999999 or $fm<1000000000){
			echo '<h3>The phone number provided is not valid!</h3>';
		}else{
		
		
		// make the update query
		$q = "UPDATE PharmaceuticalCompany SET Name='$nm', PhoneNumber='$fm' WHERE PharmaceuticalCompanyId=$ci";
