...
<?php
		...
		// define the query
		$q = "SELECT PatientId,FirstName,LastName,Town,StreetName,Number,PostalCode,Age,DoctorId FROM Patient ORDER BY PatientId ASC LIMIT $start, $display";
		$r = @mysqli_query($conn, $q);
		echo '<h3>Patient table</h3>';
		// table headers formating
		echo '</br><table align="center" cellspacing="3" cellpadding="3" width="60%">
			<tr>
				<td align="left"><h5><b>PatientId</b></h5></td>
				<td align="left"><h5><b>FirstName</b></h5></td>
				<td align="left"><h5><b>LastName</b></h5></td>
				<td align="left"><h5><b>Town</b></h5></td>
				<td align="left"><h5><b>StreetName</b></h5></td>
				<td align="left"><h5><b>Number</b></h5></td>
				<td align="left"><h5><b>PostalCode</b></h5></td>
				<td align="left"><h5><b>Age</b></h5></td>
				<td align="left"><h5><b>DoctorId</b></h5></td>
			</tr>';
		...
		if ($pages > 1){
			...
			// if it is not the first page make a previous link:
				if ($current_page !=1 ){
					echo '<a href="view_patient.php?s=' . ($start - $display) . '&p=' . $pages . '">Previous</a> ';
				}
				// make all the numbered pages:
				for ($i=1; $i<=$pages; $i++){
					if ($i != $current_page){
						echo '<a href="view_patient.php?s=' . (($display *
						($i - 1))) . '&p=' . $pages . '">' . $i . '</a> ';
					}else{
						echo $i . ' ';
					}
				...
				if ($current_page != $pages){
					echo '<a href="view_patient.php?s=' . ($start + $display) . '&p=' . $pages . '">Next</a>';
				}
				echo '</p>'; // close the paragraph
		}	
?>
<!-- end of view_patient.php script -->
