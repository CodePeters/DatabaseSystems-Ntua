    	                ...
    	                <div class="form-group last">
    	                    <div class="col-sm-offset-3 col-sm-6 pull-left">
    	                        <button type="submit" class="btn btn-warning btn-sm pull-left">
									Update</button>
								 <button class="btn btn-info btn-sm pull-right"><a href="view_drugs.php">Manage</a></button>
    	                    </div>
    	                </div>
    	                </form>
    	            </div>
...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		// check if 'formula', field which is NOT set as NOT NULL
		// in the database, is empty and if it is we set it as NULL.
		...
		// We can also check if the foreign key exists
		...
		$q = "UPDATE Drug SET Name='$nm', Formula='$fm', PharmaceuticalCompanyId=$ci WHERE DrugId=$di";
