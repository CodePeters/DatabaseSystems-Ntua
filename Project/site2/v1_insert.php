    	    ...
    	    <div class="col-md-4 col-md-offset-4">
    	        <div class="panel panel-default">
    	            ...
    	            <div class="panel-body">
    	                <form class="form-horizontal" role="form" action="v1_insert.php" method="post">
						...
						<div class="form-group">
    	                    <label for="inputName" class="col-sm-3 control-label">
    	                        Name</label>
    	                    <div class="col-sm-9">
    	                        <input type="text" class="form-control" id="inputName" 	placeholder="Pharmacy's Name" required="True" name="name">
    	                    </div>
    	                </div>
...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		$f = mysqli_real_escape_string($conn, trim($_POST['name']));
		$l = mysqli_real_escape_string($conn, trim($_POST['town']));

		$q = "INSERT INTO v1 values('$l',NULL,'$f')";
		...
		if (mysqli_affected_rows($conn)==1){
			...
			echo '<h1>Thank you!</h1><p>A new record has been successfuly inserted to the v1 View.</br></p>';
		}else{
