    	    ...
    	    <div class="col-md-4 col-md-offset-4">
    	        <div class="panel panel-default">
    	            ...
    	            <div class="panel-body">
    	                <form class="form-horizontal" role="form" action="PharmaceuticalCompany_insert.php" method="post">
    	                
						<div class="form-group">
    	                    <label for="inputName" class="col-sm-3 control-label">
    	                        Name</label>
    	                    <div class="col-sm-9">
    	                        <input type="text" class="form-control" id="inputName" 	placeholder="PharmaceuticalCompany's Name" required="True" name="name">
    	                    </div>
    	                </div>
						...
						<div class="form-group">
    	                    <label for="inputFormula" class="col-sm-3 control-label">
								Phone</label>
    	                    <div class="col-sm-9">
    	                        <input type="text" class="form-control" id="inputPhoneNumber" 	placeholder="Phone Number" required="True" name="PhoneNumber">
    	                    </div>
    	                </div>
...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		$pn = mysqli_real_escape_string($conn, trim($_POST['PhoneNumber']));
		
		// check if the phone number provided is between 1000000000 AND 9999999999
		if ($pn>9999999999 or $pn<1000000000){
			echo '<h3>The phone number provided is not valid!</h3>';
		}else{
		
		// the record doesn't already exist
		// insert query
		$q = "INSERT INTO PharmaceuticalCompany values(NULL, '$nm', '$pn')";
		...
		if (mysqli_affected_rows($conn)==1){
				...
				echo '<h1>Thank you!</h1><p>A new record has been successfuly inserted to the PharmaceuticalCompany table.</br></p>';
		}else{
